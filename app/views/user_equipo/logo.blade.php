...
@section('contenido')
    ...
    <div class="col-md-6 col-no-gutter">
        <div class="panel panel-default">
            <div class="panel-heading text-center">Subir lofo del equipo</div>
            <div class="panel-body">
                <div class="col-md-12">
                    {{ Form::open(['url'=>'jugador/logo.html','files' => true,'autocomplete'=>'off','class'=>'form_horizontal','role'=>'form'])}}
