...
@section('titulo')
    @lang('Modificar Sancion')
@stop
@section ('estilos')
    <link rel="stylesheet" type="text/css" href="{{asset('/css/pru.css')}}">
@stop
@section('titulo_cabecera')
    @lang('Sanciones')<small>@lang('')</small>
@stop
@section('ruta_navegacion')
    <li><a href="#"><i class="fa fa-list"></i> @lang('partido.sancion')</a></li>
    <li class="active">@lang('sancion.agregar_sancion')es</li>
@stop
...
@section('contenido')
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-8">
            ...
            {{ Form::open(array('url' => 'carrera/'.$Carr->idsancion,'method' => 'put', 'files' => true, 'class' => 'form-horizontal')) }}
            <div class="box box-success">
                <div class="box-header with-border" align="center">
                    <h3 class="box-title">Modificar Sancion</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                        {{ Form::label('idsancion', Lang::get('Codigo Sancion: '),array('class'=>'col-sm-2 control-label')) }}
                        <div class="col-sm-10">
                            <input id="idsancion" type="text" placeholder="Codigo Sancion" value="{{$Carr->idsancion}}" class="form-control" name="idcarrera" maxlength="5" required>
                        </div>
                    </div>
                    <div class="form-group">
