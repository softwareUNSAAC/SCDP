...
<div class="form_contenido">
    <div id="step-1">
        ...
        <div class="panel-body panel-footer">
            <div class="row">
                <div class="row col-no-gutter-container">
                    @foreach($Jugadores1 as $jugadorenjuego)
                        <div class="col-xs-6 col-md-2 col-no-gutter">
                ...
                @foreach($suplentes1 as $jugadorenjuego)
                    ...
                    <div class="col-xs-6 col-md-2 col-no-gutter">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                @if($jugadorenjuego->escapitan == 'si')
                                    <span class="glyphicon glyphicon-bookmark" title="Capitan"><span class="text-lowercase"> capitan</span> Suplente</span>
                                @else
                                    Suplente
                                @endif
                            </div>
                            ...
                            @if($jugadorenjuego->cambio=='1')
                                <div class="panel-footer">
                                    <span class="glyphicon glyphicon-collapse-down" title="fue cambiado"> fue cambiado </span>
