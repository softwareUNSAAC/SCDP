...
@section('rutanavegacion')
    <li><a href="{{ URL::to( 'usuarioequipo/listar');}}"><span > Usuarios equipo</span></a></li>
@stop
...
<div class="col-md-12 col-sm-8">
    <div class="panel panel-default">
        <div class="panel-heading">lista de usuarios de tipo equipo</div>
                ...
                <tbody>
                  @foreach($userallequipo as $user)
                      <tr>
                          ...
                          <td>{{ $user->estado }}</td>
                          <td>
                              <a class="label label-primary" href="{{ URL::to('/usuarioequipo/editar');}}/{{$user->idUsuario }}">
                                  <span class="glyphicon glyphicon-edit"></span>
                              </a>&nbsp
                              <a class="label label-danger" href="{{ URL::to('/usuarioequipo/eliminar');}}/{{ $user->idUsuario }}">
